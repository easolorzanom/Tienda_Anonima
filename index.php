				...
				<div class="card border-primary">
					...
					<div class="card-body">
                        ...
                        foreach ($productos as $productoActual) {
							...
							foreach ($categorias as $categoriaActual) {
								if($categoriaActual-> getIdCategoria() == $productoActual->getIdCategoria()){
									echo "Categoria: " .$categoriaActual -> getNombre() . "<br>";
								}
							}
							foreach ($marcas as $marcaActual) {
								if($marcaActual -> getIdMarca() == $productoActual->getIdMarca()){
									echo "Marca: " .$marcaActual -> getNombre() . "<br>";
								}
							}							
                            echo "</div>";
                            echo "</div>";
